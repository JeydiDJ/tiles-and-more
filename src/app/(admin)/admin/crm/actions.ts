  ...
  try {
    ...
    if (initialOpportunityName) {
      await createCrmOpportunity({
        ...
        architectDesignerFirm: null,
        architectDesignerContactPerson: null,
        architectDesignerPosition: null,
        architectDesignerContactNumber: null,
        architectDesignerEmail: null,
        ownerName: null,
