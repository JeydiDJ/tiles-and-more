        ...
        <section className="min-w-0 rounded-[1.5rem] border border-[#e7e9f2] bg-white p-4 shadow-[0_10px_24px_rgba(35,31,32,0.04)] sm:p-5">
          <div className="flex flex-col gap-4 border-b border-[#eef0f6] pb-5">
            ...
            <div className="rounded-[1.2rem] border border-[#eef0f6] bg-[#fafbfe] p-4">
              ...
              <p className="mt-3 break-words text-sm leading-7 text-[#6f6a75]">{account.notes || "No account notes yet."}</p>
            </div>
          </div>
            ...
            <div className="mt-4 grid gap-3">
              {opportunities.map((opportunity) => (
                ...
                >
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div className="min-w-0">
                      <p className="break-words font-medium text-[#17141a]">{opportunity.name}</p>
                      <p className="mt-1 break-words text-sm text-[#6f6a75]">{[opportunity.primaryContactName, opportunity.location].filter(Boolean).join(" - ") || "No extra opportunity details yet"}</p>
                    </div>
